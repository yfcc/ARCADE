classdef Flashbar < PixelShader
    % Flashbar < PixelShader < Stimulus - Moving 2x2 checker bar
    ...
    methods
        function obj = Flashbar()
            % file for this stimulus
            flashbarfxFile = 'Flashbar.fx';
            filename = fullfile(...
                fileparts(mfilename('fullpath')), flashbarfxFile);
